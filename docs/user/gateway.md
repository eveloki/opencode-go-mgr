...
Neither list advertises unpublished Command Code GOAT names. Eligible Custom declared IDs may appear on `/v1/models` even when they contain `/`; they are not folded into kebab aliases.
