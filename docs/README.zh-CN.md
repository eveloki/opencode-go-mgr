...
| SQLite 库版本 | `crates/ocg-core/src/db.rs`（`CURRENT_SCHEMA_VERSION = 32`）；升级/备份/回滚约定：[maintainer/storage-migration.zh-CN.md](maintainer/storage-migration.zh-CN.md) |
