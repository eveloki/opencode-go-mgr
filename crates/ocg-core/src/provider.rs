...
pub use crate::kernel::ids::{
    ...
    MINIMAX_CN_OFFERING_ID, MINIMAX_PROVIDER_ID, OLLAMA_CLOUD_BASE_URL,
    OLLAMA_CLOUD_CHAT_COMPLETIONS_PATH, OLLAMA_CLOUD_MODELS_PATH, OLLAMA_CLOUD_OFFERING_ID,
    OLLAMA_CLOUD_SETTINGS_URL, OLLAMA_PROVIDER_ID, OPENCODE_PROVIDER_ID,
...
pub use ocg_domain::provider::{
    ...
    ConfigurableHttpAdapter, ConnectionVerificationStatus, CreationAvailability, InferenceAdapter,
    ...
    KimiCnAdapter, MAX_OLLAMA_CLOUD_MODELS_CATALOG, MINIMAX_CN_BASE_URL,
    MINIMAX_CN_CHAT_COMPLETIONS_PATH, MINIMAX_CN_MODELS_PATH, MINIMAX_CN_USAGE_URL,
    MiniMaxCnAdapter, ModelCatalogAdapter, ModelCatalogDescriptor, ModelCatalogKind,
    OLLAMA_CLOUD_MODEL_SOURCE, OPENCODE_CONSTRUCTABLE_PROTOCOLS, OllamaCloudAdapter,
    OpenCodeGoAdapter, PROTOCOL_FALLBACK_CHAT_MESSAGES, PROTOCOL_FALLBACK_CHAT_RESPONSES_MESSAGES,
    PlanFormField, PricingAdapter, PricingDescriptor, ProtocolMatrixKind, ProtocolProbeAdapter,
    ...
    QUOTA_WINDOW_MONTH, QUOTA_WINDOW_WEEK, StructuralProbeCeiling, UsageAdapter, UsageContractKind,
    UsageDescriptor, VerificationAdapter, VerificationDescriptor, VerificationPolicy,
    ZenFreeAdapter, builtin_offering, builtin_plan, command_code_goat_includes_model,
    ...
    is_command_code_goat, is_custom_api, offering_allows_enablement,
