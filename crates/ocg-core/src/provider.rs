...
pub use ocg_domain::provider::{
    ...
    KimiCnAdapter, MINIMAX_CN_BASE_URL, MINIMAX_CN_CHAT_COMPLETIONS_PATH, MINIMAX_CN_MODELS_PATH,
    MINIMAX_CN_USAGE_URL, MiniMaxCnAdapter, ModelCatalogAdapter, ModelCatalogDescriptor,
    ...
    PricingAdapter, PricingDescriptor, ProtocolMatrixKind, ProtocolProbeAdapter,
